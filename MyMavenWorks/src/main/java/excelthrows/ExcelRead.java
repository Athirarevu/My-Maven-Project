...
public class ExcelRead 
{
	...
	{
		f = new FileInputStream("C:\\Users\\athir\\OneDrive\\Desktop\\Java\\ExcelRead.xlsx");     //object of FileInputStream class
	...
	{		
		...
		Row r = sh.getRow(a);           			// Getting row        
		Cell c = r.getCell(b);
		int x = (int)c.getNumericCellValue();     	// Read integer data and store the value in x [type casting]
